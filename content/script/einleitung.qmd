...
![Speicherung von Daten in nativem Python](/content/script/fig/data_memory_list.svg){#fig-python_memory fig-alt="Sequentielle Daten werden an zufälligen Orten im Speicher gespeichert"}

Dagegen werden NumPy Arrays und Matritzen zusammenhängend gespeichert, was einen
effizienteren Datenaufruf ermöglicht. 

![Speicherung von Datein bei Numpy](/content/script/fig/data_memory_numpy.svg){#fig-numpy_memory fig-alt="Sequentielle Daten werden an einem Ort im Speicher sequentiell gespeichert"}

...
Ein großer Vorteil von NumPy ist das Rechnen mit Arrays. Ohne NumPy müsste man 
...
ausdrücken: Entweder über die `np.add()` Funktion oder aber simpel über den Operator `+`.

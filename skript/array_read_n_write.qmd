...
values), kann die Funktion `np.loadtxt()` verwendet werden. Diese bekommt als 
...
Standardmäßig erwartet die `np.loadtxt()`-Funktion durch Leerzeichen getrennte Werte.
...
Enthalten die ersten Zeilen einer Datei zusätzliche Informationen wie die verwenden Einheiten oder eine Beschreibung des Experiments, können diese Zeilen mit der Option
...
Folgendes Beispiel skaliert die oben eingelesenen Daten und schreibt jeden 

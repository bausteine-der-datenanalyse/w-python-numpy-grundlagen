...
eine dreidimensionale Matrix erstellt.
...
Möglichkeiten. Mit den Befehlen `np.linspace(Start,Stopp,#Anzahl Werte)` und 
`np.arrange(Start,Stopp,Abstand zwischen Werten)` können solche Arrays erstellt 
werden.
